...
//   swiftc -O /tmp/clipprobe-build/main.swift BiscuitTin/Search/CLIPTokenizer.swift -o /tmp/clipprobe
...
let modelDir = URL(fileURLWithPath: "BiscuitTin/Resources/Models")
